...
#SBATCH --job-name=BS43_v6_nibi
#SBATCH --output=bs43_v6_nibi_output_%A_%a.txt
#SBATCH --array=0-9
#SBATCH --account=def-ikotsire_cpu
#SBATCH --mail-type=END,FAIL

# === BS(43,42) v6 — Nibi ===
# Seed offsets 10200-10209.
...
SEED_OFFSET=$((10200 + SLURM_ARRAY_TASK_ID))
BIN=wz_sa_v6_${SLURM_ARRAY_TASK_ID}

echo "=============================================="
echo "  BS(43,42) v6 — Nibi"
