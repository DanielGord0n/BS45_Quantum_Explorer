...
#SBATCH --job-name=BS45_v3_trillium
#SBATCH --output=bs45_v3_trillium_output_%A_%a.txt
#SBATCH --array=0-49
#SBATCH --account=def-ikotsire
#SBATCH --mail-type=END,FAIL

# === BS(45,44) v3 world-record campaign — Trillium ===
# Seed offsets 7300-7349.
