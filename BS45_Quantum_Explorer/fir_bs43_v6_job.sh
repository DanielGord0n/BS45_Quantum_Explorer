...
#SBATCH --job-name=BS43_v6_fir
#SBATCH --output=bs43_v6_fir_output_%A_%a.txt
#SBATCH --array=0-9
#SBATCH --account=def-ikotsire
#SBATCH --mail-type=END,FAIL

# === BS(43,42) v6 — Fir ===
# Seed offsets 10000-10009.
...
SEED_OFFSET=$((10000 + SLURM_ARRAY_TASK_ID))
BIN=wz_sa_v6_${SLURM_ARRAY_TASK_ID}

echo "=============================================="
echo "  BS(43,42) v6 — Fir"
