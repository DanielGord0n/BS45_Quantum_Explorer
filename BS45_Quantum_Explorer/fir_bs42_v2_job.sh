...
#SBATCH --job-name=BS42_v2_fir
#SBATCH --output=bs42_v2_fir_output_%A_%a.txt
#SBATCH --array=0-49
#SBATCH --account=def-ikotsire
#SBATCH --mail-type=END,FAIL

# === BS(42) v2 Solver — Fir (50 jobs, reproduction) ===
# Seed offsets 1100-1149
...
SEED_OFFSET=$((1100 + SLURM_ARRAY_TASK_ID))

echo "=============================================="
echo "  BS(42) v2 Solver — Fir"
