...
#SBATCH --job-name=BS43_v5_nibi
#SBATCH --output=bs43_v5_nibi_output_%A_%a.txt
#SBATCH --array=0-9
#SBATCH --account=def-ikotsire_cpu
#SBATCH --mail-type=END,FAIL

# === BS(43,42) v5 reproduction — Nibi ===
# Seed offsets 9200-9209.
...
SEED_OFFSET=$((9200 + SLURM_ARRAY_TASK_ID))
BIN=wz_sa_v5_${SLURM_ARRAY_TASK_ID}

echo "=============================================="
echo "  BS(43,42) v5 — Nibi"
