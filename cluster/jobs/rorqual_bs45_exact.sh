...
#SBATCH --job-name=BS45_exact_rorqual
#SBATCH --output=bs45_exact_rorqual_output_%A_%a.txt
#SBATCH --array=0-9
#SBATCH --account=def-ikotsire
#SBATCH --mail-type=END,FAIL

# === BS(45,44) EXHAUSTIVE backtracking (wz_exact) — Rorqual — WORLD RECORD ===
# DO NOT submit until wz_exact has reproduced BS(43,42). n=44.
# Rorqual searches combo quarter [2048,4096).
...
echo "=============================================="
echo "  BS(45,44) EXHAUSTIVE — Rorqual — WORLD RECORD ATTEMPT"
