...
#SBATCH --job-name=BS45_exact_trilli
#SBATCH --output=bs45_exact_trillium_output_%A_%a.txt
#SBATCH --array=0-9
#SBATCH --account=def-ikotsire
#SBATCH --mail-type=END,FAIL

# === BS(45,44) EXHAUSTIVE backtracking (wz_exact) — Trillium — WORLD RECORD ===
# DO NOT submit until wz_exact has reproduced BS(43,42). n=44.
# Trillium searches combo quarter [6144,8192).
...
echo "=============================================="
echo "  BS(45,44) EXHAUSTIVE — Trillium — WORLD RECORD ATTEMPT"
