...
#SBATCH --job-name=BS45_v8_rorqual
#SBATCH --output=bs45_v8_rorqual_output_%A_%a.txt
#SBATCH --array=0-9
...
SEED_OFFSET=$((45100 + SLURM_ARRAY_TASK_ID))
BIN=wz_sa_v8_bs45_${SLURM_ARRAY_TASK_ID}

echo "=============================================="
echo "  BS(45,44) v8 — Rorqual — WORLD RECORD ATTEMPT"
